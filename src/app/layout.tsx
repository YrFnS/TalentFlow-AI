...
import { CsrfFetchProvider } from '@/components/providers/csrf-fetch-provider';
...
export const metadata: Metadata = {
  ...
  description:
    'The next-generation HR & ATS platform powered by AI. Streamline your hiring process, find the best candidates, and make data-driven decisions.',
