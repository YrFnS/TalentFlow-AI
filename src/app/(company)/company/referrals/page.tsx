...
const statusColors: Record<ReferralStatus, string> = {
  ...
  Screening: 'bg-blue-50 text-blue-700 dark:bg-blue-950 dark:text-blue-400 border-0',
  Interviewed: 'bg-purple-50 text-purple-700 dark:bg-purple-950 dark:text-purple-400 border-0',
  Offered: 'bg-amber-50 text-amber-700 dark:bg-amber-950 dark:text-amber-400 border-0',
  Hired: 'bg-emerald-50 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-400 border-0',
...
const bonusColors: Record<BonusStatus, string> = {
  ...
  Paid: 'bg-emerald-50 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-400 border-0',
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight heading-glow">{t.referrals.title}</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {programRules.map((rule, i) => (
              <div key={i} className="flex items-start gap-3 p-3 rounded-lg bg-muted/20 border border-border/30">
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-teal-50 dark:bg-teal-950/50 text-teal-600 dark:text-teal-400">
            ...
            {leaderboard.map((entry, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-sm font-bold text-emerald-600 dark:text-emerald-400">{entry.bonusEarned}</span>
                </div>
              </div>
            ))}
          </div>
