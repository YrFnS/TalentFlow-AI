...
export default function AiGenerateDialog({
  open, onOpenChange, aiForm, onAiFormChange, onGenerate, aiGenerating, aiError, t,
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="grid gap-2">
            ...
            <Input
              ...
              value={aiForm.title}
              onChange={(e) => onAiFormChange({ ...aiForm, title: e.target.value })}
            />
          </div>
          <div className="grid gap-2">
            ...
            <Input
              ...
              onChange={(e) => onAiFormChange({ ...aiForm, department: e.target.value })}
            />
          </div>
          <div className="grid gap-2">
            <Label htmlFor="ai-level">Level</Label>
            <Select value={aiForm.level} onValueChange={(v) => onAiFormChange({ ...aiForm, level: v })}>
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="grid gap-2">
            ...
            <Textarea
              ...
              onChange={(e) => onAiFormChange({ ...aiForm, requirements: e.target.value })}
              rows={3}
            />
          </div>
        </div>
