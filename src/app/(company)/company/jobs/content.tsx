...
const statuses = ['all', 'OPEN', 'DRAFT', 'PAUSED', 'CLOSED', 'ARCHIVED'] as const;
...
export default function JobsPage() {
  ...
  async function archive(job: Job) {
    ...
    try {
      ...
      setJobs((current) => current.map((item) => item.id === job.id ? { ...item, status: 'ARCHIVED' } : item));
