...
export default function CompanyProfilePage() {
  ...
  const [formData, setFormData] = useState({
    name: 'TechVision Inc.',
    description:
      'TechVision Inc. is a leading technology company specializing in AI-powered solutions for enterprise businesses. We build innovative products that transform how organizations operate, leveraging cutting-edge machine learning, cloud computing, and data analytics to drive growth and efficiency.',
    industry: 'Technology',
    companySize: '201-500',
