    ...
    <Card className="border-border/50 card-">
      <CardContent className="p-4">
        <div className="flex items-start gap-3 mb-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between">
              ...
              <Badge className="text-[10px] bg-slate-50 text-blue-700 dark:bg-teal-950 border-0 shrink-0 ms-2">
        ...
        <div className="flex items-center gap-1 border-t border-border/30 pt-3">
          ...
          <Button variant="ghost" size="sm" className="h-7 px-2 text-xs flex-1 text-blue-600 hover:text-blue-700" onClick={() => onEngage(candidate)}>
