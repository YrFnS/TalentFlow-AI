...
export default function CompanyReportsPage() {
  ...
  const generatedReports: GeneratedReport[] = [
    { name: t.reports.hiringSummary, date: 'Mar 1, 2025', format: 'PDF', size: '2.4 MB' },
    { name: t.reports.pipelineAnalytics, date: 'Feb 28, 2025', format: 'CSV', size: '1.1 MB' },
    { name: t.reports.candidateSource, date: 'Feb 25, 2025', format: 'PDF', size: '3.2 MB' },
    { name: t.reports.interviewPerformance, date: 'Feb 20, 2025', format: 'Excel', size: '4.7 MB' },
    { name: t.reports.timeToHire, date: 'Feb 15, 2025', format: 'PDF', size: '1.8 MB' },
  ];

  const quickStats = [
    { label: t.reports.reportsThisMonth, value: '12', icon: FileBarChart, gradient: 'from-teal-500 to-emerald-600' },
    { label: t.reports.mostPopular, value: t.reports.hiringSummaryShort, icon: Trophy, gradient: 'from-emerald-500 to-teal-600' },
    { label: t.reports.avgGenerationTime, value: '3.2s', icon: Timer, gradient: 'from-cyan-500 to-teal-600' },
  ];
