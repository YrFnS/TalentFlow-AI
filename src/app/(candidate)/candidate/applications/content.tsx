...
const statusConfig: Record<AppStatus, { label: string; color: string; bgColor: string; icon: React.ElementType }> = {
  APPLIED: { label: 'Applied', color: 'text-blue-700', bgColor: 'bg-blue-100 dark:bg-blue-950', icon: Send },
  SCREENING: { label: 'Screening', color: 'text-amber-700', bgColor: 'bg-amber-100 dark:bg-amber-950', icon: Eye },
  INTERVIEW: { label: 'Interview', color: 'text-emerald-700', bgColor: 'bg-emerald-100 dark:bg-emerald-950', icon: Calendar },
  OFFERED: { label: 'Offered', color: 'text-blue-700', bgColor: 'bg-teal-100 dark:bg-teal-950', icon: CheckCircle2 },
  HIRED: { label: 'Hired', color: 'text-green-700 dark:text-green-400', bgColor: 'bg-green-100 dark:bg-green-950', icon: CheckCircle2 },
  REJECTED: { label: 'Rejected', color: 'text-red-700', bgColor: 'bg-red-100 dark:bg-red-950', icon: XCircle },
