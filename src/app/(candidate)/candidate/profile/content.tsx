...
export default function ProfilePage() {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 max-w-4xl mx-auto space-y-6">
      {/* Header */}
      <ProfileHeader onAiAnalyze={handleAiAnalyze} onSave={() => toast.success('Profile saved')} />
      ...
      <PersonalInfoCard personalInfo={personalInfo} setPersonalInfo={setPersonalInfo} />
