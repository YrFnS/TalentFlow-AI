...
const candidateNavItems = [
	...
	{
		titleKey: "videoInterview",
		href: "/candidate/video-interview",
		icon: Video,
	},
	{
		titleKey: "internalJobs",
		href: "/candidate/internal-jobs",
		icon: Building2,
	},
...
const notifications = [
	{
		...
		desc: "Your interview for Senior Developer at TechCorp is tomorrow",
		time: "2h ago",
		read: false,
		icon: Briefcase,
	...
	},
	{
		...
		desc: "Your application for Product Manager moved to Screening",
		time: "1d ago",
		read: false,
		icon: FileText,
	...
	},
	{
		id: 3,
		title: "New Job Match",
		desc: "3 new jobs match your profile",
		time: "2d ago",
		read: true,
		icon: Search,
		type: "ai" as const,
	},
	{
		id: 4,
		title: "New Message",
		desc: "Recruiter from TechVision sent you a message",
		time: "5h ago",
		read: false,
		icon: Mail,
...
function CandidateSidebar() {
	...
	return (
		<Sidebar
			...
			collapsible="icon"
			role="navigation"
			aria-label={t.candidate.myProfile}
		>
			<SidebarHeader className="p-4">
				<Link href="/candidate" className="flex items-center gap-3">
					...
					<div className="flex flex-col group-data-[collapsible=icon]:hidden">
						...
						<span className="text-[11px] text-slate-600">Candidate Portal</span>
					</div>
				</Link>
			</SidebarHeader>
			<SidebarContent>
									...
									<SidebarMenuItem key={item.titleKey}>
										<SidebarMenuButton
											...
											className={cn(
												...
												isActive &&
													"bg-slate-50 text-slate-700 sidebar-active-indicator nav-item-active",
											)}
										>
											<Link
												href={item.href}
					...
					<SidebarMenuItem className="mt-2">
						...
						>
							<button onClick={logout}>
								...
								<span className="group-data-[collapsible=icon]:hidden whitespace-nowrap text-slate-700">
									{t.common.logout}
								</span>
							</button>
						</SidebarMenuButton>
...
function Breadcrumb() {
	...
	const breadcrumbMap: Record<string, string> = {
		"/candidate": t.nav.dashboard,
		"/candidate/explore": t.nav.explore,
		"/candidate/jobs": t.nav.jobs,
		"/candidate/saved-jobs": t.nav.savedJobs,
		"/candidate/skills": t.nav.skills,
		"/candidate/assessments": t.nav.assessments,
		"/candidate/take-assessment": t.nav.takeAssessment,
		"/candidate/interview-prep": t.nav.interviewPrep,
		"/candidate/career-path": t.nav.careerPath,
		"/candidate/messages": t.nav.messages,
		"/candidate/network": t.nav.network,
		"/candidate/certifications": t.nav.certifications,
		"/candidate/learning": t.nav.learning,
		"/candidate/portfolio": t.nav.portfolio,
		"/candidate/video-interview": t.nav.videoInterview,
		"/candidate/internal-jobs": t.nav.internalJobs,
		"/candidate/notifications": t.common.notifications,
		"/candidate/applications": t.nav.applications,
		"/candidate/profile": t.common.profile,
		"/candidate/ai-tools": t.ai.aiPowered,
		"/candidate/settings": t.common.settings,
	};
							...
							{notifications.length > 0 ? (
									...
									>
										...
										<div className="flex-1 min-w-0">
											<div className="flex items-center justify-between gap-2">
												...
												{!n.read && (
													<div className="w-2 h-2 rounded-full bg-blue-500 shrink-0 notification-dot" />
												)}
											</div>
								...
								<div className="flex flex-col items-center justify-center py-8 text-muted-foreground/60 gap-3">
									...
									<p className="text-sm font-medium">
										{t.notifEnhanced?.noNotifications || "No notifications yet"}
									</p>
								</div>
							)}
						</div>
